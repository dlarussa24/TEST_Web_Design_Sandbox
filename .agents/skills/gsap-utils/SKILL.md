---
name: gsap-utils
description: Official GSAP skill for the gsap.utils namespace — clamp, mapRange, normalize, interpolate, random, snap, toArray, wrap, wrapYoyo, distribute, splitColor, selector, unitize, and pipe. Use when remapping one numeric range onto another, clamping a progress value, snapping to increments, or composing those helpers - including in plain JS with no GSAP tween involved.
license: MIT
---
