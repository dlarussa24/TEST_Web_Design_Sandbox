---
name: ui-ux-pro-max
description: "Look up concrete design options from a searchable local reference database - 192 color palettes, 74 font pairings, 84 named styles, 16 GSAP motion presets, 98 UX guidelines, 104 icon sets, 25 chart types, and stack-specific snippets for 22 stacks. Use when you already know the direction and need candidate options to choose between, or to validate a palette or type pair you derived elsewhere. Answers 'what are my options' with named entries; it does not decide the direction or write the page."
---
